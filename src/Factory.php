...
use Closure;
use Hogus\LaravelSettings\Repositories\DatabaseRepository;
use Hogus\LaravelSettings\Repositories\RedisRepository;
use Illuminate\Support\Arr;
use InvalidArgumentException;
use Hogus\LaravelSettings\Contracts\Factory as FactoryContract;
...
class Factory implements FactoryContract
{
     ...
     *
     * @param string $name
     * @return \Hogus\LaravelSettings\Contracts\Repository
     */
     ...
     *
     * @param array $config
     * @return Hogus\LaravelSettings\Repositories\DatabaseRepository
     */
     ...
     *
     * @param array $config
     * @return Hogus\LaravelSettings\Repositories\RedisRepository
     */
    protected function createRedisDriver(array $config)
    {
        $connection = $config['connection'] ??  "default";

        $prefix = $config['prefix'] ?? $this->app['config']['cache.prefix'];

        return new RedisRepository($this->app['redis'], $prefix, $connection);
    }
